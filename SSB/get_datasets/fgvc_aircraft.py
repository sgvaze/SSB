...
from SSB.custom_aircraft import FGVCAircraft, subsample_dataset, subsample_classes, get_train_val_indices, aircraft_root_dir
from SSB.utils import subsample_instances

def get_aircraft_gcd_datasets(known_classes, 
    ...
    whole_training_set = FGVCAircraft(root=aircraft_root_dir, transform=train_transform, split='trainval')
    ...
    test_dataset = FGVCAircraft(root=aircraft_root_dir, transform=test_transform, split='test')
